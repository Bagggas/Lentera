...
<body>
  ...
  <nav class="navbar navbar-expand-sm navbar-dark bg-black flex-sm-nowrap flex-wrap">
    <div class="container-fluid">
      ...
      <a href="../index.php" class="navbar-brand flex-grow-1">
  ...
  <div class="container-fluid tou-bg text-center">
    <h1 class="fw-bold text-light"> Tambah Kursus </h1>
  </div>
  <!-- starter -->
  ...
  <div class="container mt-5 mb-5">
    <div class="card">
      <h1 class="text-center fw-bold pt-3 pb-3"> Detail Kursus </h1>
      ...
      <hr class="bg-black mt-5 mb-4">

      <div class="row mt-5 pe-5 ps-5">
        <div class="card pt-3 pe-3 ps-3 pb-3">
          <h1 class="text-center fw-bold">Materi</h1>
          <div class="col-lg">
            <a href="tambah-materi.php">
              <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#modaladdkursus">
                ...
                <span class="fw-bold fs-6 mt-5">Tambah materi baru</span>
              </button>
            </a>
          </div>
      ...
      <div class="row mt-3 mb-3 pe-5 ps-5">
        <div>
