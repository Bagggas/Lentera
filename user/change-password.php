...
<body>
            ...
            <div class="tab-pane active" id="list-login" role="tabpanel">
              <form>
                ...
                <div class="form-check pb-1 text-end">
                  <a class="text-dark text-link" href="change-password.php">Lupa Kata Sandi?</a>
                </div>
  ...
  <div class="container-fluid address-container">
    <div class="row">
      <div class="col">
        <h1 class="address-title fw-bold">Kamu Lupa Password?</h1>
        <p class="t-address">jangan takut! masukkan emailmu, dan kami akan mengirimkan password lamamu.</p>
        <p>
          <div class="input-group mb-3">
            <input type="email" class="form-control me-3" placeholder="email" aria-label="email" aria-describedby="button-addon2">
            <button class="btn btn-light" type="button" id="button-addon2">Kirim</button>
          </div>
        </p>
      </div>
      <div class="col">
        <img src="../img\undraw_authentication_fsn5.svg" class="icon-adrs">
      </div>
    </div>
  </div>
  <!-- Footer -->
