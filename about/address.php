...
<body>
  ...
  <nav class="navbar navbar-expand-sm navbar-dark bg-secondary flex-sm-nowrap flex-wrap">
    <div class="container-fluid">
      <button class="navbar-toggler flex-grow-sm-2 flex-grow-0 me-2" type="button" data-bs-toggle="collapse"
  ...
  <div class="container-fluid address-container">
    <div class="row">
      <div class="col">
        <h1 class="address-title fw-bold">Contact Us</h1>
        <p class="t-address">Butuh bantuan atau keperluan lainnya? Email kita ke-</p>
        <p>
          <a class="unstyle-link adrs-link text-decoration-underline"
            href="mailto:lentera.unipma.project@gmail.com">lentera.unipma.project@gmail.com
          </a>
        </p>
        <p class="t-address lab-adrs">
          Kampus 4, Lantai 6, Laboratorium Riset Program Studi Sistem Informasi Universitas PGRI Madiun.
        </p>
      </div>
      <div class="col">
        <img src="../img/undraw_Location_search_re_ttoj.svg" class="icon-adrs">
      </div>
    </div>
  </div>

  <div class="container">
    <h1 class="t-dark text-center pt-5 pb-5 t-title fw-bold hide">Ikuti Kami</h1>
    <p class="text-center fs-5 mb-5">Temukan berbagai konten menarik di halaman sosial media kita</p>
    <div class="container">
      <div class="row text-center justify-content-center">
        <div class="col-sm-2">
          <div class="p-3 ico-pd">
            <a href="" class="unstyle-link-dark">
