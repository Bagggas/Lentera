...
<body>
  ...
  <div class="container-fluid tou-bg text-center">
    <h1 class="fw-bold text-light"> QUIZ </h1>
  </div>
  <!-- starter -->
  ...
  <div class="container">
    <div class="card mb-3">
      <ul class="list-group list-group-numbered">
        <li class="list-group-item pt-3 pb-3" aria-disabled="true">
          Lorem, ipsum dolor sit amet consectetur adipisicing elit. Dolorem sit ea ut eum quasi quo saepe debitis
          aperiam
          iure cupiditate doloribus illo sequi rerum earum, dolor sed itaque quis aut maxime quibusdam explicabo illum
          animi? Enim voluptatum odit rem repudiandae porro eaque incidunt dolores adipisci pariatur, veritatis aliquam
          consectetur ipsa.
          <form action="" class="mt-3 mb-3">
            <div class="form-check">
              <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio1" value="option1">
              <label class="form-check-label" for="inlineRadio1">Lorem ipsum dolor sit amet.</label>
            </div>
            <div class="form-check">
              <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio2" value="option2">
              <label class="form-check-label" for="inlineRadio2">Lorem, ipsum.</label>
            </div>
            <div class="form-check">
              <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio2" value="option3">
              <label class="form-check-label" for="inlineRadio3">Lorem, ipsum dolor.</label>
            </div>
            <div class="form-check">
              <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio2" value="option4">
              <label class="form-check-label" for="inlineRadio4">Lorem ipsum dolor sit amet consectetur adipisicing
                elit. Sunt, praesentium.</label>
            </div>
          </form>
        </li>
        <li class="list-group-item pt-3 pb-3" aria-disabled="true">
    ...
    <button type="button" class="btn btn-success" id="confirmation">
      Selesai
    </button>
    ...
    <div class="container">
      ...
      <div class="row pt-4 pb-4 ">
        ...
        <div class="col-md-5 mx-auto">
          ...
          <span class="ft-small">By clicking Subscribe you agree with our <a href="address.php">Terms of Use</a> & <a
  ...
  $(document).ready(function() {
    $("#confirmation").click(function() {
      Swal.fire({
        ...
        text: "Kamu tidak akan dapat mengulangi kuis ini lagi setelah menyelesaikannya",
        icon: 'warning',
