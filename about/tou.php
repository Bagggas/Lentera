...
<body>
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="list-daftar" role="tabpanel">
              <form>
                ...
                <p class="text-center">Dengan mendaftar,Anda menyetujui <a href="tou.php"> Ketentuan Penggunaan</a> dan
  ...
  <div class="container-fluid tou-bg text-center">
    <h1 class="fw-bold"> Syarat & Ketentuan Penggunaan Platform LENTERA </h1>
  </div>
  <div class="container-sm tou-container text-break">
    ...
    <ul>
      ...
      <li>
        <p>
          ...
          Anda bertanggung jawab penuh atas keputusan yang anda buat dalam mengakses dan menggunakan platform kami.
          Berperilaku baik dan tidak merugikan pihak lain.
        </p>
      </li>
      <li>
        <p>
          <span class="fw-bold">Batasan Tanggung Jawab Kami</span> <br>
          Platform yang kami sediakan adalah sebagaimana adanya dan kami tidak menyatakan menjamin bahwa keandalan,
          ketepatan waktu, kualitas, kesesuaian, ketersediaan, akurasi, kelengkapan, atau keamanan dari paltform kami
          dapat memenuhi kebutuhan dan sesuai dengan harapan anda.
        </p>
      <li>
        <p>
          <span class="fw-bold">Keadaan Kahar<span class="fst=italic">(Force Majeure)</span></span> <br>
          Platform kami dapat diinterupsi oleh kejadian di luar kewenangan atau kontrol kami (Keadaan Kahar) seperti
          bencana alam, gangguan listrik , telekomunikasi, kebijakan pemerintah, dan lainnya. Anda setuju untuk
          membebaskan kami dari setiap tuntutan dan tanggung jawab jika kami tidak dapat memfasilitasi layanan karna
          keadaan ini.
        </p>
      </li>
      <li>
        <p>
          ...
          tindakan anda menkan tombol daftar saat pembukaan akun dan tombol masuk saaat akan mengakses akun anda
          merupakan persetujuan aktif anda untuk mengikatkan diri dalam perjanjian dengan kami.
        </p>
        <p>
          Kami berhak merubah syarat dan ketentuan berlaku, memperbaharui paltform dari waktu kewaktu, serta mengubah
          konten yang ada pada platform kami. Dan anda tidak dapat mengajukan tuntutanatau keberatan terhadap keabsahan
          dari syarat dan ketentuan atau kebijakan privasi yang dibuat dalam bentuk elektronik.
        </p>
      </li>
      <li>
        <p>
    ...
    <p>Saya telah membaca dan mengerti seluruh syarat dan ketentuan ini dan konsekuensinya dan dengan ini menerima
      setiap hak, kewajiban dan ketentuan yang diatur di dalamnya.</p>
  </div>
