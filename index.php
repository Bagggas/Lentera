...
<body>
  ...
  <!-- jumbotron -->
  <div class="jumbotron">
    <video src="video/hero.mp4" autoplay muted loop>
    </video>
    <div class="container-sm jumbotron-container">
      <h1 class="display-4 materi">Materi khusus dapat diakses secara gratis</h1>
      <hr class="my-4">
      <p class="lead">
      <div class="text-center">
        <button type="button" class="btn btn-lg btn-primary btn-daftar" data-bs-toggle="modal"
          data-bs-target="#modal-login">Daftar
          Sekarang</button>
      </div>
      </p>
    </div>
  ...
  <div class="container-fluid bg-primary">
    <img src="gif/1-1.gif" class="wave-top" alt="Flowers in Chania">
    <div class="container pt-2">
      <h1 class="t-dark text-start pb-3 t-title fw-bold hide">Tentang Lentera</h1>
      <!-- START THE FEATURETTES -->
      <div class="row featurette hide">
        <div class="col-md-7">
          <h2 class="featurette-heading pt-5">Visi</h2>
          <p class="lead">Menjadi salah satu <span class="fst-italic">Platform Massive Online Course
            </span>di bidang <span class="fst-italic">Digital Technology dan Entrepreneur Character.</span>
          </p>
        </div>
        <div class="col-md-3">
          <img src="img\undraw_Notify_re_65on.svg" class="icon-bottom">
        </div>
      </div>
      ...
      <div class="row featurette hide">
        ...
        <div class="col-md-7 order-md-2">
          <h2 class="featurette-heading pt-5">Misi</h2>
          <p class="lead">Pada tahun 2021, menjadi<span class="fst-italic"> Platform Online Course</span> di
            bidang Teknologi dan pengembangan karakter <span class="fst-italic">Entrepreneur</span> Bagi mahasiswa
            UNIPMA</p>
        </div>
        <div class="col-md-3 order-md-1">
          <img src="img\undraw_Reading_book_re_kqpk.svg" class="icon-left">
        </div>
      </div>

      <hr class="featurette-divider mt-5 mb-5">

      <div class="row featurette pt-3 hide">
        <div class="col-md-7">
          <h2 class="featurette-heading pt-3">Apa tujuan kami membangun <span
              class="fw-bold fs-1 block-lentera">LENTERA</span> itu?</h2>
          <p class="lead">Tujuan kami adalah untuk membantu mewujudkan karakter mahasiswa UNIPMA yang memiliki wawasan
            teknologi digital dan
            memiliki karakter <span class="fst-italic"> Entrepreneur</span></p>
        </div>
        <div class="col-md-3 order-md-1">
          <img src="img\undraw_Design_thinking_re_644h.svg" class="icon-bottom" alt="">
        </div>
      </div>
      <!-- /END THE FEATURETTES -->
    </div>
    <img src="gif/22.gif" class="wave-bottom hide" alt="Flowers in Chania">
  </div>
  <!-- featured end -->

  <!-- carousel -->
  <div class="container-sm pb-5 hide">
    <h1 class="t-dark text-center pt-5 fw-bold">Our Members</h1>
    <div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active" data-bs-interval="10000">
          <img src="./img/bg.jpg" class="d-block w-100 carousel-image" alt="...">
          <div class="carousel-caption d-none d-md-block carousel-item-setting">
            <div class="row">
              <div class="col-lg-4">
                <img src="img\pdimas.jpg" width="140" height="140" class="bd-placeholder-img rounded-circle mb-3"
                  role="img" aria-label="Placeholder: 140x140" preserveAspectRatio="xMidYMid slice" focusable="false">
                <h2 class="h2-name">Dimas Setiawan, M.Kom</h2>
                <p class="fst-italic fw-lighter">Founder Lentera Project, UX Researcher</p>
              </div><!-- /.col-lg-4 -->

              <div class="col-lg-4">
                <img src="img\bagas.jpg" width="140" height="140" class="bd-placeholder-img rounded-circle mb-3"
                  role="img" aria-label="Placeholder: 140x140" preserveAspectRatio="xMidYMid slice" focusable="false">
                <h2 class="h2-name">Ignatius Bagas Kurniawan</h2>
                <p class="fst-italic fw-lighter">Front End Developer</p>
              </div><!-- /.col-lg-4 -->

              <div class="col-lg-4">
                <img src="img\tobi.jpg" width="140" height="140" class="bd-placeholder-img rounded-circle mb-3"
                  role="img" aria-label="Placeholder: 140x140" preserveAspectRatio="xMidYMid slice" focusable="false">
                <h2 class="h2-name">Tobi Dwiongko Saputra</h2>
                <p class="fst-italic fw-lighter">UX Designer</p>
              </div><!-- /.col-lg-4 -->
            </div><!-- /.row -->
          </div>
        </div>
        <div class="carousel-item" data-bs-interval="2000">
          ...
          <div class="carousel-caption d-none d-md-block carousel-item-setting">
            <div class="row justify-content-center">
              <div class="col-lg-4">
                <img src="img\naufal.jpg" width="140" height="140" class="bd-placeholder-img rounded-circle mb-3"
                  role="img" aria-label="Placeholder: 140x140" preserveAspectRatio="xMidYMid slice" focusable="false">
                <h2 class="h2-name">Naufal Rafianto</h2>
                <p class="fst-italic fw-lighter">UX Designer</p>
              </div><!-- /.col-lg-4 -->


              <div class="col-lg-4">
                <img src="img\ardi.jpg" width="140" height="140" class="bd-placeholder-img rounded-circle mb-3"
                  role="img" aria-label="Placeholder: 140x140" preserveAspectRatio="xMidYMid slice" focusable="false">
                <h2 class="h2-name">Ardiansyah</h2>
                <p class="fst-italic fw-lighter">Office Man</p>
                <br>
              </div><!-- /.col-lg-4 -->
            </div><!-- /.row -->
          </div>
