...
<body>
    ...
    <div class="container-fluid">
      ...
      <div class="btn-group">
        ...
        <ul class="dropdown-menu dropdown-menu-end">
          ...
          <hr class="id-divider">
          <li><a href="user/profile.php" class="dropdown-item" type="button"> Nopasu</a></li>
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="list-daftar" role="tabpanel">
              <form>
                ...
                <p class="text-center">Dengan mendaftar,Anda menyetujui <a href="about/tou.php"> Ketentuan
                    Penggunaan</a> dan <a href="about/pp.php">kebijakan Privasi</a>.</p>
  ...
  <div aria-live="polite" aria-atomic="true" class="bg-dark position-relative bd-example-toasts toast-cont">
    <div class="toast-container position-fixed p-3 bottom-0 start-0" id="toastPlacement">
      <div class="toast" data-bs-autohide="false">
        <div class="toast-header">
          <strong class="me-auto text-danger">Kamu memiliki quiz baru!</strong>
          <small>11 mins ago</small>
          <button type="button" class="btn-close" data-bs-dismiss="toast" aria-label="Close"></button>
        </div>
        <div class="toast-body">
          Selesaikan berbagai macam quiz untuk mendapatkan sertifikat keahlian yang dapat digunakan sebagai pendamping
          ijasah mu.
          <div class="mt-2 pt-2 border-top">
            <a href="user/quiz.php"><button type="button" class="btn btn-primary btn-sm">Kerjakan Quiz</button></a>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="container-fluid container-dark text-start video-container">
    <div class="container">
      <div class="row pb-5">
        <h1 class="text-light pt-5 pb-2" id="selected-menu"><span class="menuTitle">Materi 1</span></h1>
        <video id="videoarea" controls="controls" poster="" src="" controlsList="nodownload" control
          oncontextmenu="return false;"></video>
        <div class="col text-start playlist-container">
          <h3 class="text-light text-center mb-3">PELAJARAN</h3>
          <div class="playlist-container overflow-auto">
            <ul id="playlist" class="list-group list-group-flush list-group-numbered">
              <li type="button" id="myBtn" class="list-group-item list-black active" movieurl="video/trailer.mp4"
                alt="Materi 1">Materi 1</li>
              <li class="list-group-item list-black" movieurl="video/trailer2.mp4">Materi 2</li>
              <li class="list-group-item list-black" movieurl="video/trailer.mp4">Materi 3</li>
              <li class="list-group-item list-black" movieurl="video/trailer2.mp4">Materi 4</li>
              <li class="list-group-item list-black" movieurl="video/trailer.mp4">Materi 5</li>
              <li class="list-group-item list-black" movieurl="video/trailer2.mp4">Materi 6</li>
              <li class="list-group-item list-black" movieurl="video/trailer2.mp4">Materi 7</li>
              <li class="list-group-item list-black" movieurl="video/trailer2.mp4">Materi 8</li>
              <li class="list-group-item list-black" movieurl="video/trailer2.mp4">Materi 9</li>
              <li class="list-group-item list-black" movieurl="video/trailer2.mp4">Materi 10</li>
              <li class="list-group-item list-black" movieurl="video/trailer2.mp4">Materi 11</li>
              <li class="list-group-item list-black" movieurl="video/trailer2.mp4">Materi 12</li>
            </ul>
          </div>
        </div>
      </div>
  ...
  <div class="container">
    <div class="card mt-5">
      <div class="card-body">
        <h5 class="card-title">Deskripsi Materi</h5>
        <p class="card-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Non, sit voluptate similique sed
          corporis laborum saepe eos! Autem ullam atque eveniet temporibus totam dolore laborum ex eum consequuntur
          voluptates, ut soluta, sapiente ipsa id dolor! Ipsum tenetur ex nemo veniam, quo praesentium dignissimos autem
          modi quisquam doloribus fuga quasi blanditiis?.</p>
      </div>
    </div>

    <div class="d-flex justify-content-center flex-column text-center p-2 sertifikat-container"
      style="height: 200px; disabled">
      <div class="row justify-content-center">
        <div class="col-sm2">
          <h1 class="t-dark text-center pb-3 t-title fw-bold hide"> SERTIFIKAT REWARD</h1>
          <button type="submit" class="btn btn-dark">Klik untuk mengambil sertifikat reward</button>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="container mt-3 pb-2">
    <div class="row featurette mb-5">
      ...
      <div class="col-md-7">
        ...
        <p class="lead">Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatem enim voluptate nam fugiat
          aut hic animi natus nobis? Deserunt, quisquam minus. Aliquid laborum corrupti impedit, fugiat natus nobis
          necessitatibus at.</p>
      </div>
    </div>
  </div>
      ...
      <div class="row pt-4 pb-4 ">
        ...
        <div class="col-md-1">
          <a class="btn-floating btn-fb unstyle-link" href="index.php">
            <embed src="img/logo-white.svg" width="50" height="65">
          </a>
        </div>
