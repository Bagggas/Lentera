...
<body>
  ...
  <div class="container-fluid tou-bg text-center">
    <h1 class="fw-bold text-light"> Galeri Kursus </h1>
  </div>
  <!-- starter -->
  ...
  <div class="container">
    ...
    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
      <div class="col">
        ...
        <img src="img/tobi.jpg" alt=""  width="100%" height="225" class="img-responsive" />
          <div class="card-body">
            <p class="card-text">Lorem ipsum dolor sit amet.</p>
            <div class="d-flex justify-content-between align-items-center">
              <div class="btn-group">
                <a href="kursus.php"><button type="button" class="btn btn-sm btn-outline-secondary">View</button></a>
              </div>
            </div>
          </div>
        </div>
